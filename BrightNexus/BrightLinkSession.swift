...
// BrightNexus
//
// SDI-EB v3 session machinery (RFC §4.5).
//
// This file is the Swift counterpart of the test-harness's `mock-brightnexus`
// SDI surface. Every constant, byte order, and field offset here is taken
...
enum BrightLinkSession {
    ...
    /// Decoded `SDI_REGISTER` envelope plaintext — see RFC §4.5.1.
    ...
    enum BrightLinkError: Error, CustomStringConvertible {
        ...
        var description: String {
            ...
            case .unsupportedVersion: return "Unsupported SDI protocol version"
