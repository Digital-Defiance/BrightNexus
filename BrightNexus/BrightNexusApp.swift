...
//
//  Architectural notes — see docs/rfc-brightlink-v1.md:
...
struct SettingsView: View {
    ...
    var body: some View {
        TabView {
            ...
            SDISettingsView()
                .tabItem {
                    Label("SDI", systemImage: "key.viewfinder")
                }
        ...
        // 250pt was too tight once the About panel switched from a 48pt SF
        // symbol to an 80pt-tall wordmark. Give the TabView room to breathe
        // so neither tab's content gets clipped.
        .frame(width: 450, height: 380)
    }
}

// MARK: - SDI Settings (RFC §4.9.5)

struct SDISettingsView: View {
