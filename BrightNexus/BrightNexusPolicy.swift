...
// BrightNexus
//
// Centralised, user-configurable policy knobs for BrightLink behavior.
//
...
struct BrightNexusPolicy {
    ...
    private enum Keys {
        static let peerAttestationMode = "brightlink.peerAttestationMode"
        static let credentialTtlCeilingSeconds = "brightlink.credentialTtlCeilingSeconds"
    }
